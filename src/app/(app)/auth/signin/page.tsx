      ...
      <div className="rounded-2xl border border-slate-800 bg-slate-900/50 p-8">
        ...
        <div className="space-y-3">
          <button
            type="button"
            disabled
            className="flex w-full items-center justify-center gap-3 rounded-xl border border-slate-700 bg-slate-800/50 px-4 py-3 text-sm font-medium text-slate-400 cursor-not-allowed opacity-50"
          >
